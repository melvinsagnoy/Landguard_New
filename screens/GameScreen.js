...
import { View, StyleSheet, Dimensions, Text, Button, ImageBackground, TouchableOpacity } from 'react-native';
...
const RoadFighterGame = () => {
  ...
  const onHandlerStateChange = (event) => {
    if (event.nativeEvent.state === State.ACTIVE || event.nativeEvent.state === State.CHANGED) {
